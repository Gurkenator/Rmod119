...
public class NomadFactionForgeBlockEntityRenderer implements BlockEntityRenderer<NomadFactionForgeBlockEntity> {
    ...
    public NomadFactionForgeBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    ...
    @Override
    public void render(NomadFactionForgeBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBufferSource,
...
//		int glow = data.calculateGlowLight(0);
    ...
    private void renderItem(ItemStack stack, NomadFactionForgeBlockEntity pBlockEntity, PoseStack pPoseStack, MultiBufferSource pBufferSource,
                            int pPackedLight, int pPackedOverlay)
    {
        pPoseStack.pushPose();
        ItemRenderer itemRenderer = Minecraft.getInstance().getItemRenderer();
...
//			Lighting.turnOff();
    ...
    private LiquidRenderer.Model3D getFluidModel(float fluidLevel, FluidRenderData data)
    {
