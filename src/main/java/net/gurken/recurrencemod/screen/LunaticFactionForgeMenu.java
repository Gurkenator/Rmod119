...
public class LunaticFactionForgeMenu extends AbstractContainerMenu {
    public final LunaticFactionForgeBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public LunaticFactionForgeMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(7));
    }

    public LunaticFactionForgeMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.LUNATIC_FACTION_FORGE_MENU.get(), pContainerId);
        checkContainerSize(inv, 7);
        blockEntity = (LunaticFactionForgeBlockEntity) entity;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.LUNATIC_FACTION_FORGE.get());
    }
